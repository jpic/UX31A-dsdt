 ...
 * AML Disassembler version 20121018-32 [Oct 26 2012]
 * Copyright (c) 2000 - 2012 Intel Corporation
 * 
 * Disassembly of dsdt.dat, Fri Nov  2 11:44:49 2012
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00011CFD (72957)
 *     Revision         0x02
 *     Checksum         0x4D
 *     OEM ID           "_ASUS_"
...
DefinitionBlock ("dsdt.aml", "DSDT", 2, "_ASUS_", "Notebook", 0x00000013)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xBE8A1E18, 0x01D1)
    ...
    Scope (_SB.PCI0.LPCB.EC0)
    {
        Name (PWAC, Buffer (0x40)
        {
            ...
            /* 0010 */   0x11, 0x21, 0x2F, 0x40, 0x4E, 0x5F, 0x6D, 0x7B,
    ...
    Scope (\)
    {
        ...
        {
            /* 0000 */   0xFF, 0xFF, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0x00,
            /* 0008 */   0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00
        })
